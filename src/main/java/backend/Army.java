...
public class Army {
	...
	private void armyJSON(List<Troop> list, PrintWriter printWriter) {

		int counter = 0;
		printWriter.printf("[");

		for (Troop troop : list) {
			printWriter.printf("\"" + troop.name() + "\"");
	...
	public void toJSON(PrintWriter printWriter) {
		...
		printWriter.printf(",");
		printWriter.printf("\"stack\":");
		armyJSON(stack,printWriter);
		printWriter.printf(",");
		printWriter.printf("\"captured\":");
		armyJSON(captured,printWriter);
		printWriter.printf("}");
	}
